...
public class ApiTest {
    ...
    public void checkObjectPost() {
        Pet pet = new Pet();
        int id = 236078792;
//        int id = new Random().nextInt(); // просто нужно создать произвольный айди
...
//        Assert.assertEquals(actual.getId(), -236078792);
//        Assert.assertEquals(actual.getName(), pet.getName()); //было
    }
    @Test(priority = 2)
